...
- [Analysis of Code Refactoring](#analysis-of-code-refactoring)
  - [Implementation and Code Snippet](#implementation-and-code-snippet)
- [Runtime Performance Analysis](#runtime-performance-analysis)
  - [Results](#results)
  - [Runtime Performance Benchmarking](#runtime-performance-benchmarking)
- [Summary](#summary)
...
Module 2 assignment consists of code refactoring exercises and a detailed analysis of how we refactor our VBA code to boost its runtime performance when looping through big datasets. Refactored codes are expected to provide more efficient data visualization without sacrificing the statistical outcomes and quality of data analysis. Outline of our deliverables and a written report for presenting our results and analysis summary:
...
- ☑️ Deliverable 1: Refactor VBA code and measure its performance. This includes snapshots of runtime performance comparison when analyzing 2018 and 2017 green energy stock data as follows.
  - Pre-/post-refactored codes ([VBA_Challenge.xlsm workbook](./02_wall-street/VBA_Challenge.xlsm) and [VBA_Challenge.vbs](./02_wall-street/VBA_Challenge.vbs))
  - Snapshots of analysis results ([Fig. 1](./02_wall-street/resources/VBA_Challenge_2017.png "Fig. 1 VBA runtime performance for the year 2017"), [Fig. 2](./02_wall-street/resources/VBA_Challenge_2018.png "Fig. 2 VBA runtime performance for the year 2018"), and [Fig. 3](./02_wall-street/resources/VBA_Runtime_Performance_Analysis.png "Fig. 3 VBA runtime performance analysis and visualization"))
...
- Turning off four built-in Excel Application properties alone shortened runtime by about 26&ndash;27% compared to keeping the default settings on for those four Application properties.
...
- Disadvantages include:
  ...
  - reduced readability. Extreme code refactoring could make the code less readable (refer to *AllStocksAnalysisRefactoredNoComment()* sub).
